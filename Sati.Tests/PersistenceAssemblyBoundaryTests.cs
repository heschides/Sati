...
public sealed class PersistenceAssemblyBoundaryTests
{
    ...
    public void ContextEntitiesAndEntireMigrationChainAreCrossPlatform()
    {
        ...
        Assert.Equal(117, migrationIds.Count);
        ...
        Assert.Contains("20260913164040_AddOadsAuthoringSettings", migrationIds);
        ...
        Assert.Contains("20260911022820_AddClearinghouseResponseIntake", migrationIds);
        ...
        Assert.Contains(migrationIds, id => id!.EndsWith("_AddCrashDiagnosticReadback", StringComparison.Ordinal));
    }
}
