...
public static class ApiSurface
{
    ...
    [
        ...
        "exact-date-billing-compliance-resolution-v1",
        ...
        "recipient-release-obligations-v1",
        "recipient-release-note-correction-v1",
        "admin-claimed-source-date-correction-v1",
    ...
    [
        ...
        "GET /api/v1/admin/notes/{noteId:int}/release-date-correction-target",
        ...
        "GET /api/v1/billing/remittance-deposits/{depositId:long}/eft",
        ...
        "GET /api/v1/service-day-inclusions/{year:int}",
        "GET /api/v1/settings",
        "GET /api/v1/settings/billing-compliance-policies",
        "GET /api/v1/settings/billing-compliance-requirements",
        ...
        "POST /api/v1/admin/notes/{noteId:int}/correct-release-date",
        ...
        "POST /api/v1/billing/remittance-deposits/{depositId:long}/eft",
        "POST /api/v1/billing/responses",
        ...
        "POST /api/v1/settings/billing-compliance-policies",
        "POST /api/v1/settings/billing-compliance-policies/preview",
        ...
        "PUT /api/v1/service-day-inclusions",
        "PUT /api/v1/settings",
