...
namespace Sati.Persistence.Migrations
{
    ...
    [Migration("20260923180000_ReconcileDuplicateScheduledAgendaNotes")]
    partial class ReconcileDuplicateScheduledAgendaNotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sati.Models.Billing.ClaimAcknowledgementOutcome", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AgencyId", "EdiGenerationId", "ClaimReference");

                    b.ToTable("ClaimAcknowledgementOutcomes", (string)null);
                });

            modelBuilder.Entity("Sati.Models.Billing.ClaimCorrection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("CorrectsEdiGenerationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("CorrectsEdiGenerationId");

                    b.HasIndex("RequestedByUserId");

                    b.HasIndex("AgencyId", "BillingPeriodId");

                    b.ToTable("ClaimCorrections", (string)null);
                });

            modelBuilder.Entity("Sati.Models.Billing.ClaimCorrectionSubmission", b =>
                {
                    b.Property<long>("ClaimCorrectionId")
                        .HasColumnType("bigint");

                    b.Property<long>("EdiGenerationId")
                        .HasColumnType("bigint");

                    b.HasKey("ClaimCorrectionId", "EdiGenerationId");

                    b.HasIndex("EdiGenerationId");

                    b.ToTable("ClaimCorrectionSubmissions", (string)null);
                });
            ...
            modelBuilder.Entity("Sati.Models.Billing.EftDepositRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("BankTraceNumber")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");
                    ...
                    b.Property<long>("RemittanceDepositId")
                        .HasColumnType("bigint");

                    b.Property<long?>("SupersedesRecordId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RemittanceDepositId");

                    b.HasIndex("SupersedesRecordId")
                        .IsUnique()
                        .HasFilter("[SupersedesRecordId] IS NOT NULL");

                    b.HasIndex("AgencyId", "RemittanceDepositId");
            ...
            modelBuilder.Entity("Sati.Models.ServiceDayInclusion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ServiceDayInclusions");
                });
            ...
            modelBuilder.Entity("Sati.Models.Billing.ClaimCorrection", b =>
                {
                    ...
                    b.HasOne("Sati.Models.Billing.EdiGeneration", null)
                        .WithMany()
                        .HasForeignKey("CorrectsEdiGenerationId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Sati.Models.Billing.ClaimCorrectionSubmission", b =>
                {
                    b.HasOne("Sati.Models.Billing.ClaimCorrection", null)
                        .WithMany()
                        .HasForeignKey("ClaimCorrectionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sati.Models.Billing.EftDepositRecord", b =>
                {
                    ...
                    b.HasOne("Sati.Models.Billing.RemittanceDeposit", null)
                        .WithMany()
                        .HasForeignKey("RemittanceDepositId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sati.Models.Billing.EftDepositRecord", null)
                        .WithMany()
