...
*Route manifest updated 2026-09-12: 182 protected routes. The table is maintained with
...
| Billing | `GET /billing/candidates` | Note person's owning user's `AgencyId` | Billing permission; candidates joined to actor agency. The purpose-built response contains only note/date/minutes, opaque person/owner ids, override fact, and server-derived readiness errors. It cannot serialize note narrative, visit documentation, override reason, or consumer names. |
